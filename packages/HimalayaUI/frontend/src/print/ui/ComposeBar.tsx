  ...
  return (
    <div
      ...
      className={cx(
        ...
        "fixed left-1/2 bottom-20 -translate-x-1/2 z-50 flex items-center gap-1 bg-ink text-paper rounded-md shadow-lg pl-4 pr-2 py-[7px] transition duration-300 ease-out",
