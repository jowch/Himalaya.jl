      ...
      {options.map((opt, idx) => {
        ...
        return (
          <button
            ...
            className={cx(
              "seg-segment whitespace-nowrap transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent",
              sizeClass[size],
