...
- [ ] **Wave 2 — P1 fixes top-down** ← IN PROGRESS. ✅ F-LIVE (`c07cdce`). ✅ F-ERRSILENT (closed-by-architecture — see row). Next cross-cutting P1s: **F-CONTRAST** (app-wide token, verify 3.16:1 first), the **rail adapt** (BU-RAIL+FO-RAIL+FO-COMB), **SC-HEAD** (region headings). Then surface-specific P1s.
