...
- HimalayaUI — Plans 1–7 + three-card Index redesign + Inspect page + experiment-config system + skeleton loading + chat @-mentions + multiplayer + instrumentation foundation complete:
